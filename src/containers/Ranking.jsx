  ...
  {   this.state.showSnackBar&&
     ...
     <div className="row space-1">
      ...
      <table  width={1000} style={{tableLayout:'auto'}} class="table table-striped table-bordered"  >
        <thead>
          <tr>
          <th class="th-sm">Domain Authority
            </th>
            <th class="th-sm" >Page Authority
            </th>
            <th class="th-sm">Moz Rank
            </th>
            <th class="th-sm">Links In
            </th>
            <th class="th-sm"> SemRush Domain
            </th>
            <th class="th-sm">SemRush Rank
            </th>
            <th class="th-sm">SemRush Keywords num
            </th>
            {/* <th class="th-sm">Ratings
            </th> */}
            <th class="th-sm">SemRush Traffic
            </th>
            <th class="th-sm">SemRush Costs
            </th>
            <th class="th-sm">SemRush URL Links num
            </th>
            <th class="th-sm">SemRush HOST Links num
            </th> 
            <th class="th-sm">SemRush DOMAIN Links num
            </th>
            <th class="th-sm">Facebook comments
            </th>
            <th class="th-sm">Facebook shares
            </th>
            <th class="th-sm">Facebook reactions
            </th>
            {/* <th class="th-sm">Edit
            </th>
